...
VALUES
  (
    1,
    'admin',
    'bff8af1fe092a663b838c4c7c0c90f11',
    '1888888888',
    'admin@163.com',
    1,
    1,
...
INSERT INTO
  `auth`
VALUES
  (19, '', '订单列表', 2, '/order', 6, 0, '', 0, 0, 0);
INSERT INTO
  `auth`
VALUES
  (20, '', '导航管理', 2, '/menu', 7, 0, '', 0, 0, 0);
INSERT INTO
  `auth`
VALUES
  (21, '', '商城设置', 2, '/setting', 7, 0, '', 0, 0, 0);
COMMIT;
-- ----------------------------
...
INSERT INTO
  `product_attr`
VALUES
  (12, 2, 1, 1, '平板电脑', 1, '', 10, 1610940762, 1);
COMMIT;
-- ----------------------------
...
INSERT INTO
  `role`
VALUES
  (2, '技术部', '技术部', 1, 1603518015);
INSERT INTO
  `role`
VALUES
  (3, '运营部', '运营部', 1, 1603518054);
COMMIT;
-- ----------------------------
